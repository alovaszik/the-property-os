...
function ReasonCard({
  ...
  return (
    <div className="flex flex-col gap-3 p-5 rounded-lg bg-card border border-border hover:border-primary/30 transition-colors">
...
export function WhyUs() {
  return (
    <section id="why" className="relative px-5 py-20 lg:px-10 lg:py-24">
